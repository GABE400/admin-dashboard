...
export default function LoginPage() {
  ...
  const onSubmit = (values: LoginFormValues) => {
    ...
    // Simulate API authorization and redirect to dashboard
    setTimeout(() => {
      setIsLoading(false);
  ...
  return (
    <Card className="border border-border/80 shadow-md bg-card">
      <CardHeader className="space-y-1">
        ...
        <CardDescription>
          Enter your metrics credentials below to access your SaaS account
        </CardDescription>
      </CardHeader>
      <CardContent className="space-y-4">
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
          ...
          <div className="space-y-1.5">
            <div className="flex items-center justify-between">
              ...
              <Link
                ...
                className="text-xs font-semibold text-primary hover:text-indigo-500 transition-colors"
              >
                Forgot password?
              </Link>
            </div>
          ...
          <div className="flex items-center space-x-2">
            ...
            <label
              htmlFor="rememberMe"
              className="text-xs font-semibold text-muted-foreground hover:text-foreground select-none cursor-pointer"
            >
        ...
        <div className="relative flex items-center justify-center py-2">
          ...
          <span className="relative z-10 bg-card px-3 text-[10px] font-bold tracking-widest uppercase text-muted-foreground">
            Or continue with
          </span>
        </div>
        ...
        <div className="grid grid-cols-2 gap-3">
          <Button
            variant="outline"
            className="w-full gap-2 border-border/85 cursor-pointer"
            onClick={() => alert("Google Auth integration: UI Demonstration")}
          >
            {/* Google SVG logo */}
          ...
          <Button
            variant="outline"
            className="w-full gap-2 border-border/85 cursor-pointer"
            onClick={() => alert("GitHub Auth integration: UI Demonstration")}
          >
            {/* GitHub SVG logo */}
            <svg className="h-4 w-4" viewBox="0 0 24 24" fill="currentColor">
